...
export const DashboardView: React.FC = () => {
  ...
  const { setActiveTab, setIsLocationModalOpen } = useNavigation();
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <CardEntrance delay={0.2}>
            <MetricCard
              ...
              icon={Activity}
              trend="down"
              status={currentLocation.humidity > 60 ? 'elevated' : 'optimal'}
          ...
          <CardEntrance delay={0.3}>
            <MetricCard
              ...
              icon={Flame}
              trend="up"
              trendLabel="High solar load"
              status={currentLocation.uvIndex > 6 ? 'critical' : currentLocation.uvIndex > 3 ? 'elevated' : 'optimal'}
