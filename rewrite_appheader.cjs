...
import { getEnvironmentalStatus } from '../../utils/colorMap';
...
const AppHeader: React.FC = () => {
  ...
  const { setIsDemoTourOpen, setIsFabricModalOpen, isMobileMenuOpen, setIsMobileMenuOpen } = useNavigation();
  ...
  const statusLabel =
    connectionStatus === 'connected'
      ? getEnvironmentalStatus(currentLocation)
...
`
fs.writeFileSync('src/components/common/AppHeader.tsx', content);
